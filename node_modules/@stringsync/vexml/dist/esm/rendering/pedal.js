...
export class Pedal {
    ...
    renderVexflowPedalMarkings(renders) {
        const vexflowPedalMarkings = new Array();
    ...
    renderSinglePedalMarking(renders) {
        const vexflowStaveNotes = new Array();
