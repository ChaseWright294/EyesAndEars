...
const cheaplocator_1 = require("./cheaplocator");
const expensivelocator_1 = require("./expensivelocator");
...
class Cursor {
    ...
    static create(scrollContainer, score, sequence, span) {
        ...
        for (const system of score.getSystems()) {
            const rect = spatial_1.Rect.merge(system
                .getMeasures()
        ...
        const cheapLocator = new cheaplocator_1.CheapLocator(sequence);
        const expensiveLocator = new expensivelocator_1.ExpensiveLocator(sequence);
        return new Cursor({
            scroller,
            states,
            sequence,
