...
class MeasureSequenceIterator {
    ...
    [Symbol.iterator]() {
        ...
        const activeRepeats = new util.Stack();
        function getState() {
...
exports.MeasureSequenceIterator = MeasureSequenceIterator;
...
class Repeat {
    ...
    static from(measures) {
        const result = new Array();
        let nextId = 1;
        const startMeasureIndexes = new util.Stack();
    ...
    isMeasureExcluded(measureIndex) {
