import { AccidentalCode, AnnotationHorizontalJustification, AnnotationVerticalJustification, ArticulationPlacement, ArticulationType as ArticulationType, BarlineStyle, BendType, ClefSign, CurveArticulation, CurveOpening, CurvePlacement, DurationType, DynamicType, EndingBracketType, KeyMode, Notehead, PedalMarkType, PedalType, RepetitionSymbol, StemDirection, TimeSymbol, TupletPlacement, WedgePlacement, WedgeType } from './enums';
export type Score = {
    type: 'score';
    title: string | null;
    partLabels: string[];
